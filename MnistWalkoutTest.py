...
# DERP
#RESULT_PATH = "MNIST_WALKOUT_TEST_LOW_KLD/"
RESULT_PATH = "MNIST_WALKOUT_TEST_MAX_KLD/"
#RESULT_PATH = "MNIST_WALKOUT_TEST_MED_KLD/"
PRIOR_DIM = 50
LOGVAR_BOUND = 6.0
...
if __name__=="__main__":
    # FOR MAX KLD REGULARIZATION
    #pretrain_osm(lam_kld=20.0)
    #train_walk_from_pretrained_osm(lam_kld=20.0)

    # FOR MED KLD REGULARIZATION
    #pretrain_osm(lam_kld=5.0)
    #train_walk_from_pretrained_osm(lam_kld=5.0)

    # FOR LOW KLD REGULARIZATION
    pretrain_osm(lam_kld=1.2)
    train_walk_from_pretrained_osm(lam_kld=1.2)